...
export const CalendarNav = (props) => {
  ...
  let startMonthTitle = startDate.toLocaleString("en-us", {month: "short"}).toLowerCase();
  let endMonthTitle = endDate.toLocaleString("en-us", {month: "short"}).toLowerCase();
  ...
  }, startMonthTitle, " ", yearStart, " - ", endMonthTitle, " ", yearEnd), /* @__PURE__ */ React.createElement("div", {
    className: "next",
    id: "nextBtnCalendar"
  }));
};
